...
WebUI.verifyElementPresent(findTestObject('Page_CURA Healthcare Service/header_Make Appointment'), 3)

WebUI.verifyElementPresent(findTestObject('Page_CURA Healthcare Service/button_Book Appointment'), 3)
